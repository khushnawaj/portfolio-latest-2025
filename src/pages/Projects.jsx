    ...
    <div className="pt-28 px-6 max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-neon/5 to-cyan-500/5 border border-neon/20 rounded-2xl p-8 md:p-12 mb-20">
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <span className="px-4 py-2 bg-neon/20 text-neon rounded-lg font-medium">REST APIs</span>
          <span className="px-4 py-2 bg-neon/20 text-neon rounded-lg font-medium">Payment Integration</span>
          <span className="px-4 py-2 bg-neon/20 text-neon rounded-lg font-medium">Admin Dashboard</span>
          <span className="px-4 py-2 bg-neon/20 text-neon rounded-lg font-medium">Cloud Deployment</span>
        </div>
        
        <div className="flex flex-wrap gap-4">
          <a
            href="/projects/scentiva"
